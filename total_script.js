...
xhttp.open("GET", "https://coronavirus-19-api.herokuapp.com/countries", true);
xhttp.send();  
...
function searchFunction(){
    ...
    for(i;i<(data.length-1);i++) {
        if(country_name== data[i].country){
    ...
    document.getElementById("total_death").innerHTML =data[country_index].deaths;
